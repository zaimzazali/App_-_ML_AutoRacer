...
echo mlagents-learn .\settings\%yamlName%.yaml --env=.\build\ML_AutoRacer_Trainer --run-id=%runID% --no-graphics --resume 
mlagents-learn .\settings\%yamlName%.yaml --env=.\build\ML_AutoRacer_Trainer --run-id=%runID% --no-graphics --resume
